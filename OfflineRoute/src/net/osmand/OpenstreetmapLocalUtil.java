...
public class OpenstreetmapLocalUtil implements OpenstreetmapUtil {
	...
	public final static Log log = OsmLogUtil
			.getLog(OpenstreetmapLocalUtil.class);
	...
	public Node loadNode(Amenity n) {
		...
		Node entity = new Node(n.getLocation().getLatitude(), n.getLocation()
				.getLongitude(), nodeId);
		...
		// check whether this is node (because id of node could be the same as
		// relation)
		if (entity != null
				&& MapUtils.getDistance(entity.getLatLon(), n.getLocation()) < 50) {
			return entity;
		}
		return null;
	}
