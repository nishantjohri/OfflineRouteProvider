...
public class OnNavigationServiceAlarmReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		final NavigationService service = ((OsmandApplication) context
				.getApplicationContext()).getNavigationService();
		// do not do nothing
		...
		locationManager.requestLocationUpdates(service.getServiceOffProvider(),
				0, 0, service);
