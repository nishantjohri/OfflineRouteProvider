...
public interface RegionAddressRepository {
	...
	public static class MapObjectNameDistanceComparator implements
		...
		public MapObjectNameDistanceComparator(boolean useEnName,
				LatLon location) {
		...
		public int compare(MapObject object1, MapObject object2) {
			if (object1 == null || object2 == null) {
				...
				int c = collator.compare(object1.getName(useEnName), object2
						.getName(useEnName));
				if (c == 0 && location != null) {
					...
					return Double.compare(MapUtils.getDistance(location, l1),
							MapUtils.getDistance(location, l2));
				}
				return c;
			}
		}
