...
public class TipsAndTricksActivity {
	private int[][] tipNamesAndDescriptions = new int[][] {
			...
			{ R.string.tip_rotation_switching,
					R.string.tip_rotation_switching_t },
			...
			{ R.string.tip_select_destination_point,
					R.string.tip_select_destination_point_t },
	...
	public Dialog getDialogToShowTips(boolean showFirst, boolean random) {
		...
		final TextView tipDescription = (TextView) dlg
				.findViewById(R.id.TipDescription);
		...
		final Button prevButton = (Button) dlg
		...
		nextButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				tipDescription.setText(getTipDescription(toShow
						.get(historyInd[0])));
