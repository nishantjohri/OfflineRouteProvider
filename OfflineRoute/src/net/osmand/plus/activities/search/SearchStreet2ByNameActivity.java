...
public class SearchStreet2ByNameActivity extends
		...
		return new AsyncTask<Object, Void, List<Street>>() {
			...
			protected void onPostExecute(List<Street> result) {
				((TextView) findViewById(R.id.Label))
						.setText(R.string.incremental_search_street);
			...
			protected void onPreExecute() {
				((TextView) findViewById(R.id.Label))
						.setText(R.string.loading_streets);
			...
			protected List<Street> doInBackground(Object... params) {
				...
				if (region != null) {
					...
					if (postcode != null) {
						street1 = region.getStreetByName(postcode, (settings
								.getLastSearchedStreet()));
						if (street1 != null) {
							city = street1.getCity();
						}
					} else if (city != null) {
						street1 = region.getStreetByName(city, (settings
								.getLastSearchedStreet()));
					}
	...
	public void itemSelected(Street obj) {
		settings.setLastSearchedIntersectedStreet(obj.getName(region
				.useEnglishNames()), region
				.findStreetIntersection(street1, obj));
		finish();
	}
}
