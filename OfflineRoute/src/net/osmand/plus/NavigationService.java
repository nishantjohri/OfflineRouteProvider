...
public class NavigationService extends Service implements LocationListener {
	...
	public void onCreate() {
		...
		routingHelper = ((OsmandApplication) getApplication())
				.getRoutingHelper();
		...
		if (isContinuous()) {
			...
			locationManager.requestLocationUpdates(serviceOffProvider, 0, 0,
	...
	public void onLocationChanged(Location location) {
		if (location != null && !settings.MAP_ACTIVITY_ENABLED.get()) {
			...
			savingTrackHelper.insertData(location.getLatitude(), location
					.getLongitude(), location.getAltitude(), location
					.getSpeed(), location.getAccuracy(), location.getTime(),
					settings);
			liveMonitoringHelper.insertData(location.getLatitude(), location
					.getLongitude(), location.getAltitude(), location
					.getSpeed(), location.getAccuracy(), location.getTime(),
					settings);
			if (routingHelper.isFollowingMode()) {
