...
public abstract class MapInfoControl extends View {
	...
	public void setWDimensions(int w, int h) {
		setMeasuredDimension(w + padding.left + padding.right, h + padding.top
				+ padding.bottom);
	}
	...
	protected final void onLayout(boolean changed, int left, int top,
		...
		onWLayout(right - left - padding.left - padding.right, bottom - top
	...
	protected void drawShadowText(Canvas cv, String text, float centerX,
			float centerY, Paint textPaint) {
