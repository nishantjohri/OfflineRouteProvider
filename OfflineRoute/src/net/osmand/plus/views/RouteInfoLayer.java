...
public class RouteInfoLayer extends OsmandMapLayer implements
			...
			public void onClick(View v) {
				if (routingHelper.getRouteDirections() != null
					...
					Location l = routingHelper
							.getLocationFromRouteDirection(info);
					if (info.descriptionRoute != null) {
						contextMenu.setLocation(new LatLon(l.getLatitude(), l
								.getLongitude()), info.descriptionRoute);
					}
					view.getAnimatedDraggingThread().startMoving(
	...
	public boolean isVisible() {
		return visible && routingHelper.isRouteCalculated()
