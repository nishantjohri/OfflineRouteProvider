...
public class SearchByNameFilter extends PoiFilter {
	...
	public SearchByNameFilter(OsmandApplication application) {
		super(application.getString(R.string.poi_filter_by_name), FILTER_ID,
	...
	protected List<Amenity> searchAmenities(double lat, double lon,
		...
		searchedAmenities = application.getResourceManager()
				.searchAmenitiesByName(query, topLatitude, leftLongitude,
						bottomLatitude, rightLongitude, lat, lon, matcher);
